...
pub const STANDARD_VERTEX_STRIDE: u32 = 44;

pub const STANDARD_INDEX_FORMAT: DXGI_FORMAT = DXGI_FORMAT_R32_UINT;
...
macro_rules! textures_array {
    { $( { $width:literal,
        $height:literal,
        1,
        $format:expr,
        { { $offset:literal, $size:literal, $pitch:literal } , } }, )* }
    =>
    {
        [
        $(
...
pub struct DrawParameters {
    pub diffuse_texture_index: isize,
    pub normal_texture_index: isize,
    pub specular_texture_index: isize,
